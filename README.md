# metrics
Simple shorthand for printing application metrics in a specific format


## Pushing a new version
Set the `Version` number in the <a href="https://github.com/mhlabs/mhlabs.metrics/blob/master/mhlabs.metrics/mhlabs.metrics.csproj"> .csproj-file</a> before pushing. If an existing version is pushed the <a href="https://github.com/mhlabs/mhlabs.metrics/actions">build will fail</a>.
